...
export type BusinessFinancialServicesBannerSectionProps = {
  data: {
...
const BusinessFinancialServicesBannerSectionComponent: PuckComponent<
  BusinessFinancialServicesBannerSectionProps
...
export const BusinessFinancialServicesBannerSection: YextComponentConfig<BusinessFinancialServicesBannerSectionProps> =
  {
        ...
        text: {
          ...
          constantValue: {
            defaultValue: getDefaultRTF(
              "Build confidence in your financial future with guidance tailored to your goals.",
            ),
          },
    ...
    render: (props) => (
      ...
      >
        <BusinessFinancialServicesBannerSectionComponent {...props} />
      </VisibilityWrapper>
    ),
  };
