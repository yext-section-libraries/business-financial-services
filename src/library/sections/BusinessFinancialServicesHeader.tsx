...
type BusinessFinancialServicesHeaderProps = {
...
const resolveThemeColorCssValue = (color?: ThemeColor): string | undefined => {
  ...
  if (
    ...
    color.selectedColor.endsWith("]")
  ) {
    return color.selectedColor.slice(1, -1);
  }
...
const getTextStyles = ({
  ...
  return {
    ...
    letterSpacing:
      styles.letterSpacing === "default"
        ? "var(--letterSpacing-link-letterSpacing)"
        ...
        <div className="flex flex-wrap items-center gap-3">
          <BackgroundProvider
            value={{
              ...
              isDarkColor: isDarkColor(props.section.backgroundColor),
            }}
          >
...
export const BusinessFinancialServicesHeader: YextComponentConfig<BusinessFinancialServicesHeaderProps> =
  {
    ...
    render: (props) => (
      <AnalyticsScopeProvider
        name={`BusinessFinancialServicesHeader${getAnalyticsScopeHash(props.id)}`}
      >
        <BusinessFinancialServicesHeaderComponent {...props} />
      </AnalyticsScopeProvider>
    ),
  };

export const config: SectionConfig = {
  id: "BusinessFinancialServicesHeader",
  displayName: "Header",
  description: "Header",
